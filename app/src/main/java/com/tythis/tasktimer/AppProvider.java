...
/**
 * Created by Brian Medendorp on 8/8/2019
 *
...
public class AppProvider extends ContentProvider {
    ...
    static final String CONTENT_AUTHORITY = "com.tythis.tasktimer.provider";
    ...
    /*
      ...
      private static final int  TASK_TIMINGS = 301;
     */
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        // eg. content://com.tythis.tasktimer.provider/Tasks
        matcher.addURI(CONTENT_AUTHORITY, TasksContract.TABLE_NAME, TASKS);
        // eg. content://com.tythis.tasktimer.provider/Tasks/8
